-- ============================================================
-- PATCH: Perbaiki kecocokan Bcrypt ($2b$ vs $2a$)
-- Masalah: pgcrypto di PostgreSQL memproses hash bcrypt dengan 
-- prefix $2a$, sedangkan library Node.js (bcryptjs/bcrypt) 
-- menghasilkan prefix $2b$.
--
-- Solusi: fungsi fn_login secara otomatis mengubah prefix $2b$ 
-- menjadi $2a$ sebelum mencocokkan password.
-- ============================================================
