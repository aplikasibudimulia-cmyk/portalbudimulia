-- ============================================================
-- PATCH: Perbaiki error "function crypt does not exist"
-- Masalah: pgcrypto terinstall di schema 'extensions', tapi
-- fungsi fn_login diset search_path = public saja.
--
...
-- Update fungsi fn_login dengan search_path yang menyertakan 'extensions'
...
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path = public, extensions  -- TAMBAHKAN extensions DI SINI
AS $$
DECLARE
...
BEGIN
  ...
  -- Gunakan schema extensions secara eksplisit untuk crypt agar aman
  IF extensions.crypt(p_password, v_akun.password) <> v_akun.password THEN
