          ...
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl overflow-hidden animate-fade-in">
            ...
            <form onSubmit={handleSave} className="p-5 space-y-4">
              <div>
                ...
                <input type="text" required value={formData.nama} onChange={e => setFormData({...formData, nama: e.target.value})} placeholder="Contoh: Matematika" className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none text-sm" />
              </div>
              <div>
                ...
                <input type="text" value={formData.singkatan} onChange={e => setFormData({...formData, singkatan: e.target.value})} placeholder="Contoh: MTK" className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none text-sm" />
              </div>
